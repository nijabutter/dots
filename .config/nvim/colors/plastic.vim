...
let s:black = { 'gui': '#0D1117', 'cterm256': '234'}
...
call <sid>hi('Identifier', s:whisky, s:none, 'none', {})
call <sid>hi('Function', s:purple, s:none, 'none', {})
...
call <sid>hi('Special', s:whisky, s:none, 'none', {})
...
call <sid>hi('Variable', s:aqua, s:none, 'italic', {})
